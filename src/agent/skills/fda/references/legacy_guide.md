...
Primary agent tool: **`query_fda`** (`src/tools/search/tools_agent.py`). Prefer it over ad-hoc openFDA scripts. For deep API recipes see `references/`.
